...
<div className={Layout.page}>
  ...
  <div className={Layout.introduction}>
    ...
    <div className={Layout.description}>
      ...
      <p>People used to dark, espresso roast coffee may surprised to hear me describe filter coffee as bright, with notes of fruit. Follow along to give it a try!</p>
    </div>
