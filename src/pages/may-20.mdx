...
<Footer date={20} prev={true} next={true}>

One of my favourite projects in the past few years has been putting together [Photoessays][p] for travels and other events.

I can certainly see a lot of potential with Gatsby, MDX, and CSS Grid to enhance future Photoessays.

I also tried using [gatsby-image][gi] for this layout. I quite like the way it automates the process of optimising images, but unfortunately it’s a bit inflexible for positioning and scaling.

[p]: https://brett.cool/photoessays/
