...
<Footer date={17} prev={true} next={true}>

Just over halfway through now! (Okay technically that was yesterday). Hard to believe it! This month (and year) has just flown by.

I have more thoughts on this particular topic. Part of the problem with these entries is not so much the design or coding part, but also, the content. I have a vague idea of what I want to be able to write, but unfortunately, unlike design and code, writing doesn’t really work for me under tight deadline conditions.

Although definitely not sustainable indefinitely, these kind of design and code exercises are very much equivalent to any exercise, and keeping up motivation and making it a habit are the best way to see results.
